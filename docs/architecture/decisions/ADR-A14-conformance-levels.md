...
An eight-level conformance ladder replaces any single global valid/invalid gate. Full detail, including per-level required checks, lives in the companion reference [../conformance-levels.md](../conformance-levels.md).
