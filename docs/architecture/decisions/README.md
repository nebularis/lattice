...
| [A-86](ADR-A86-ontology-semantic-versioning.md) | Semantic versioning for ontology documents | Proposed |
...
| [A-83](ADR-A83-test-only-reasoning-engine-isolation.md) | Test-only reasoning engine isolation | Proposed |
