...
<div class="callout quote"><strong>From <code>ontology/spc/spec/spc.ttl</code> —</strong> "Contravariant functor 𝒪: SPC^op → DL is realized by conservative extension patterns; narrowing behavior in SPC corresponds to expanding knowledge in DL."</div>
